...
class TestGradCAMMethods:
    ...
    def test_gradcam_and_gradcampp_produce_different_heatmaps(
        self, model, rand_tensor, device
    ):
    ...
    def test_different_layers_produce_different_heatmaps(
        self, model, rand_tensor, device
    ):
        x = rand_tensor.to(device)
...
class TestGradCAMDeterminism:
    ...
    def test_probability_consistent_with_direct_inference(
        self, model, rand_tensor, device
    ):
